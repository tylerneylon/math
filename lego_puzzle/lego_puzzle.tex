...
\begin{center}\includegraphics[width=0.9\textwidth,height=\textheight]{img/solution_steps.pdf}\end{center}
...
the center cubie. There are 6 of these:

\begin{center}\includegraphics[width=0.5\textwidth]{img/face_cubies.pdf}\end{center}
...
BrickLink}, which is awesome, and I'm grateful it's free.
