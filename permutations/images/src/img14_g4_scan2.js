/* img14_g4_scan2.js
 *
 * A variant of ing13 that shows a random rotation of the permutohedron.
 * I guess the lesson here is that the exploded graph can look quite wonky.
 *
 */
...
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    let [pts, labels]   = perm2.getG4PointsIn3D('random', 11);
