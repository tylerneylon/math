...
\((\,f_L \restrict [1\tfrac{1}{3}, 1\tfrac{2}{3}]) = g\). Below, I'll
...
\begin{equation}\big(\,f_L \restrict 1 + 0.1\overline{*}_3\big) = g.\label{eq:nonpl_base_case}\end{equation}

It's possible to generalize this last equation so that it defines
\(f_L\) almost everywhere on the interval \([1, 2]\).

\textbf{Theorem} \emph{For any \(k\ge 0\),
